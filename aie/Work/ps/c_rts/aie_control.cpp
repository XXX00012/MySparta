...
/************************** Functions/APIs *****************************/
  ...
  void topStencil_init(const std::string& work_path)
  {
	...
	std::string work_dir = (work_path.empty() ?  "/media/4T/home/xianyijiang/my_sparta/aie/./Work" : work_path);
	// S_EAST_ch3_C6_R1 M_NORTH_ch5_C6_R1 net1

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(6, 2), EAST, 3, NORTH, 5);

	// S_EAST_ch3_C6_R2 M_S2MM_DMA_ch1_C6_R2 net5

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(6, 3), EAST, 3, DMA, 1);

	// S_EAST_ch3_C7_R1 M_NORTH_ch3_C7_R1 net3

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 2), EAST, 3, NORTH, 3);

	// S_MM2S_DMA_ch0_C7_R4 M_SOUTH_ch3_C7_R4 net17

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 5), DMA, 0, SOUTH, 3);
	...
	// S_NORTH_ch3_C7_R3 M_SOUTH_ch3_C7_R3 net17

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 4), NORTH, 3, SOUTH, 3);

	// S_SHIM_NORTH_ch3_C7 M_SHIM_SOUTH_ch0_C7 net17

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 0), NORTH, 3, SOUTH, 0);

	// S_SHIM_SOUTH_ch0_C7 M_SHIM_NORTH_ch3_C7 net1
	...
	// S_SHIM_SOUTH_ch2_C7 M_SHIM_NORTH_ch2_C7 net0

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 0), SOUTH, 2, NORTH, 2);

	// S_SHIM_SOUTH_ch4_C7 M_SHIM_NORTH_ch5_C7 net7

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 0), SOUTH, 4, NORTH, 5);

	// S_SHIM_SOUTH_ch6_C7 M_SHIM_EAST_ch3_C7 net3

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 0), SOUTH, 6, EAST, 3);

	// S_SHIM_WEST_ch3_C8 M_SHIM_NORTH_ch5_C8 net3

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(8, 0), WEST, 3, NORTH, 5);

	// S_SOUTH_ch2_C7_R0 M_S2MM_DMA_ch0_C7_R0 net0

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 1), SOUTH, 2, DMA, 0);

	// S_SOUTH_ch3_C7_R0 M_NORTH_ch3_C7_R0 net1

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 1), SOUTH, 3, NORTH, 3);

	// S_SOUTH_ch3_C7_R0 M_S2MM_DMA_ch1_C7_R0 net1

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 1), SOUTH, 3, DMA, 1);

	// S_SOUTH_ch3_C7_R1 M_WEST_ch3_C7_R1 net1

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 2), SOUTH, 3, WEST, 3);

	// S_SOUTH_ch3_C7_R2 M_NORTH_ch5_C7_R2 net3

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 3), SOUTH, 3, NORTH, 5);

	// S_SOUTH_ch4_C7_R0 M_NORTH_ch4_C7_R0 net5

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 1), SOUTH, 4, NORTH, 4);

	// S_SOUTH_ch4_C7_R1 M_NORTH_ch4_C7_R1 net5

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 2), SOUTH, 4, NORTH, 4);

	// S_SOUTH_ch4_C7_R2 M_S2MM_DMA_ch0_C7_R2 net5

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 3), SOUTH, 4, DMA, 0);

	// S_SOUTH_ch4_C7_R2 M_WEST_ch3_C7_R2 net5

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 3), SOUTH, 4, WEST, 3);

	// S_SOUTH_ch5_C6_R2 M_S2MM_DMA_ch0_C6_R2 net1

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(6, 3), SOUTH, 5, DMA, 0);

	// S_SOUTH_ch5_C7_R0 M_NORTH_ch5_C7_R0 net7

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 1), SOUTH, 5, NORTH, 5);

	// S_SOUTH_ch5_C7_R1 M_NORTH_ch5_C7_R1 net7

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 2), SOUTH, 5, NORTH, 5);

	// S_SOUTH_ch5_C7_R2 M_S2MM_DMA_ch1_C7_R2 net7

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 3), SOUTH, 5, DMA, 1);

	// S_SOUTH_ch5_C7_R3 M_S2MM_DMA_ch0_C7_R3 net3

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(7, 4), SOUTH, 5, DMA, 0);

	// S_SOUTH_ch5_C8_R0 M_NORTH_ch5_C8_R0 net3

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(8, 1), SOUTH, 5, NORTH, 5);

	// S_SOUTH_ch5_C8_R1 M_S2MM_DMA_ch0_C8_R1 net3

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(8, 2), SOUTH, 5, DMA, 0);

	// S_SOUTH_ch5_C8_R1 M_WEST_ch3_C8_R1 net3

	XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(8, 2), SOUTH, 5, WEST, 3);
	...
	//Setting buffer buf5 of topStencil.core.k_lap.in[3]
	{
	...
	//Setting buffer buf5d of topStencil.core.k_lap.in[3]
	{
		XAie_DmaDesc DmaInst;
		XAie_DmaDescInit(&DevInst, &DmaInst, XAie_TileLoc(7, 3));
	...
	//Setting buffer buf3 of topStencil.core.k_lap.in[2]
	{
		XAie_DmaDesc DmaInst;
	...
	//Setting buffer buf3d of topStencil.core.k_lap.in[2]
	{
		XAie_DmaDesc DmaInst;
		XAie_DmaDescInit(&DevInst, &DmaInst, XAie_TileLoc(8, 2));
	...
	//Setting buffer buf2 of topStencil.core.k_flux1.in[0]
	{
		XAie_DmaDesc DmaInst;
	...
	//Setting buffer buf2d of topStencil.core.k_flux1.in[0]
	{
		XAie_DmaDesc DmaInst;
		XAie_DmaDescInit(&DevInst, &DmaInst, XAie_TileLoc(6, 3));
		XAie_DmaSetAddrLen(&DmaInst, 0x2000, 1024);
	...
	//Setting buffer buf7 of topStencil.core.k_lap.in[4]
	{
		XAie_DmaDesc DmaInst;
		XAie_DmaDescInit(&DevInst, &DmaInst, XAie_TileLoc(7, 3));
		XAie_DmaSetAddrLen(&DmaInst, 0x400, 1024);
		XAie_DmaSetLock(&DmaInst, XAie_LockInit(2, 0), XAie_LockInit(2, 1));
		XAie_DmaSetNextBd(&DmaInst, 3, XAIE_ENABLE);
		XAie_DmaEnableBd(&DmaInst);
		XAie_DmaWriteBd(&DevInst, &DmaInst, XAie_TileLoc(7, 3), 2);
	}

	//Setting buffer buf7d of topStencil.core.k_lap.in[4]
	{
		XAie_DmaDesc DmaInst;
		XAie_DmaDescInit(&DevInst, &DmaInst, XAie_TileLoc(7, 3));
		...
		XAie_DmaEnableBd(&DmaInst);
		XAie_DmaWriteBd(&DevInst, &DmaInst, XAie_TileLoc(7, 3), 3);
	}

	XAie_DmaChannelPushBdToQueue(&DevInst, XAie_TileLoc(7, 3), 1, DMA_S2MM, 2);
	XAie_DmaChannelEnable(&DevInst, XAie_TileLoc(7, 3), 1, DMA_S2MM);

	//Setting buffer buf4 of topStencil.core.k_flux1.in[1]
	{
		XAie_DmaDesc DmaInst;
		XAie_DmaDescInit(&DevInst, &DmaInst, XAie_TileLoc(7, 4));
		XAie_DmaSetAddrLen(&DmaInst, 0x1000, 1024);
		XAie_DmaSetLock(&DmaInst, XAie_LockInit(0, 0), XAie_LockInit(0, 1));
		XAie_DmaSetNextBd(&DmaInst, 1, XAIE_ENABLE);
		XAie_DmaEnableBd(&DmaInst);
	...
	//Setting buffer buf4d of topStencil.core.k_flux1.in[1]
	{
		XAie_DmaDesc DmaInst;
		XAie_DmaDescInit(&DevInst, &DmaInst, XAie_TileLoc(7, 4));
		XAie_DmaSetAddrLen(&DmaInst, 0x3c00, 1024);
		XAie_DmaSetLock(&DmaInst, XAie_LockInit(1, 0), XAie_LockInit(1, 1));
		XAie_DmaSetNextBd(&DmaInst, 0, XAIE_ENABLE);
		XAie_DmaEnableBd(&DmaInst);
	...
	//Setting buffer buf6 of topStencil.core.k_flux1.in[2]
	{
		XAie_DmaDesc DmaInst;
		XAie_DmaDescInit(&DevInst, &DmaInst, XAie_TileLoc(6, 3));
		XAie_DmaSetAddrLen(&DmaInst, 0x4000, 1024);
	...
	//Setting buffer buf6d of topStencil.core.k_flux1.in[2]
	{
		XAie_DmaDesc DmaInst;
		XAie_DmaDescInit(&DevInst, &DmaInst, XAie_TileLoc(6, 3));
		XAie_DmaSetAddrLen(&DmaInst, 0x6000, 1024);
	...
	{
		XAie_DmaDesc DmaInst;
		XAie_DmaDescInit(&DevInst, &DmaInst, XAie_TileLoc(7, 5));
		XAie_DmaSetAddrLen(&DmaInst, 0x0, 1024);
		XAie_DmaSetLock(&DmaInst, XAie_LockInit(0, 1), XAie_LockInit(0, 0));
		XAie_DmaSetNextBd(&DmaInst, 1, XAIE_ENABLE);
		XAie_DmaEnableBd(&DmaInst);
		XAie_DmaWriteBd(&DevInst, &DmaInst, XAie_TileLoc(7, 5), 0);
	}
	...
	//Setting buffer buf17d of topStencil.core.k_flux2.out[0]
	{
		...
		XAie_DmaSetNextBd(&DmaInst, 0, XAIE_ENABLE);
		XAie_DmaEnableBd(&DmaInst);
		XAie_DmaWriteBd(&DevInst, &DmaInst, XAie_TileLoc(7, 5), 1);
	}

	XAie_DmaChannelPushBdToQueue(&DevInst, XAie_TileLoc(7, 5), 0, DMA_MM2S, 0);
	XAie_DmaChannelEnable(&DevInst, XAie_TileLoc(7, 5), 0, DMA_MM2S);
...
/************************** Clock gating *****************************/
  ...
  {
    XAie_LocType locs[12] = {XAie_TileLoc(6, 2), XAie_TileLoc(6, 3), XAie_TileLoc(7, 1), XAie_TileLoc(7, 2), XAie_TileLoc(7, 3), XAie_TileLoc(7, 4), XAie_TileLoc(7, 5), XAie_TileLoc(8, 1), XAie_TileLoc(8, 2), XAie_TileLoc(8, 4), XAie_TileLoc(7, 0), XAie_TileLoc(8, 0), };
    XAie_PmRequestTiles(&DevInst, locs, 12);
...
/************************** Graph Configurations  *****************************/
  ...
  //{id, name, graphLoadElfFunc, graphInitFunc, graphDebugHalt, coreColumns, coreRows, iterMemColumns, iterMemRows, iterMemAddrs, triggered, plKernelInstanceNames, plAxiLiteModes, plDriverStartFuncs, plDriverCheckIPDoneFuncs}
    {0, "topStencil", &topStencil_load_elf, &topStencil_init, &topStencil_core_debug_halt, {7, 7, 7}, {1, 2, 3}, {8, 7, 8}, {1, 1, 3}, {0x4, 0x17e4, 0x4}, {0, 0, 0}, {}, {}, {}, {},  }, 
  };
...
/************************** PLIO Configurations  *****************************/
  ...
  //{id, name, loginal_name, shim_column, slaveOrMaster, streamId}
    {0, "topStencil.in_plio[0]", "hdiff_in0", 7, 0, 2},
    {1, "topStencil.in_plio[1]", "hdiff_in1", 7, 0, 0},
    {2, "topStencil.in_plio[2]", "hdiff_in2", 7, 0, 6},
    {3, "topStencil.in_plio[3]", "hdiff_in3", 7, 0, 1},
    {4, "topStencil.in_plio[4]", "hdiff_in4", 7, 0, 4},
    {5, "topStencil.out_plio", "hdiff_out0", 7, 1, 0},
  };
